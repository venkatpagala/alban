...
set PATH=%M2_HOME%/bin;%JAVA_HOME%/bin;%GRAPHVIZ_HOME%\bin;%SVN_HOME%\bin;%NODEJS_HOME%
set PATH=%PATH%;C:\Documents and Settings\alban.andrieu\Application Data\npm\;C:\Documents and Settings\alban.andrieu\Application Data\npm\node_modules\karma\bin
set CLASSPATH=.;%JAVA_HOME%\bin;%M2_HOME%\bin;%ANT_HOME%\bin;%GRAPHVIZ_HOME%\bin;%SVN_HOME%\bin;%NODEJS_HOME%
echo %CLASSPATH%
