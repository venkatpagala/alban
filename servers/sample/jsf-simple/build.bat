...
call mvn clean verify -Psample -Dserver=tomcat7x -Ddatabase=derby -Dwebdriver.chrome.driver="C:\chromedriver\chromedriver.exe" -Dwebdriver.base.url=http://home.nabla.mobi:8280 > install.log 2>&1
REM OK call mvn clean verify -Psample -Dserver=jetty9x -Ddatabase=derby -Dwebdriver.chrome.driver="C:\chromedriver\chromedriver.exe" -Dwebdriver.base.url=http://localhost:9090 > install.log 2>&1
