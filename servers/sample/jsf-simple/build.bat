...
REM OK call mvn clean verify -Psample -Dserver=tomcat7x -Ddatabase=derby -Dwebdriver.chrome.driver=/var/lib/chromedriver -Dwebdriver.base.url=http://localhost:8280 > install.log 2>&1
call mvn clean verify -Psample -Dserver=jetty9x -Ddatabase=derby -Dwebdriver.chrome.driver="C:\chromedriver\chromedriver.exe" > install.log 2>&1
