...
/**
 * Web service delegator for {@link org.andromda.test.howto5.a.RentalServiceBean}.
 *
 * @see org.andromda.test.howto5.a.RentalServiceBean
 */
    ...
    extends ServiceDelegateBase
{
    ...
    {
        return ServiceLocator.getInstance().get_org_andromda_test_howto5_a_RentalServiceBean_Remote(getProperties());
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto5.a.RentalServiceBean#getAllCars()
     *
     * @return List
     */
    public List getAllCars()
    {
        ...
        catch (NamingException ex)
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto5.a.RentalService.getAllCars()' --> " + ex, ex);
        }
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto5.a.RentalServiceBean#getCustomersByName(String)
     *
     * @param name
     * @return List
     */
    public List getCustomersByName(String name)
    {
        ...
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto5.a.RentalService.getCustomersByName(String name)' --> " + ex, ex);
        }
    }
