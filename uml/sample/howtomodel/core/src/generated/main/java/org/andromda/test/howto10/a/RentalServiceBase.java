...
public abstract class RentalServiceBase implements RentalService
{
     ...
     */
    @Resource(mappedName = "queue/howtomodel/howto10a")
    ...
    public List getCustomersByName(String name) throws RentalException
    {
        if (name == null)
        {
            throw new IllegalArgumentException("org.andromda.test.howto10.a.RentalServiceBean.getCustomersByName(String name) - 'name' can not be null");
        }
        try
        {
