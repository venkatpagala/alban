...
public abstract class CarDaoBase implements CarDao
{
     ...
     */
    @Override
    public Car create(String name, String type, byte[] picture, char[] information) throws CarDaoException
    {
     ...
     */
    @Override
    public Object create(final int transform, String name, String type, byte[] picture, char[] information) throws CarDaoException
    {
        Car entity = new Car();
        entity.setName(name);
        entity.setType(type);
