...
/**
 * Web service delegator for {@link org.andromda.test.howto6.a.RentalServiceBean}.
 *
 * @see org.andromda.test.howto6.a.RentalServiceBean
 */
    ...
    extends ServiceDelegateBase
{
    ...
    {
        return ServiceLocator.getInstance().get_org_andromda_test_howto6_a_RentalServiceBean_Remote(getProperties());
    }
    ...
    public List getAllCars()
    {
        ...
        catch (NamingException ex)
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto6.a.RentalService.getAllCars()' --> " + ex, ex);
        }
    }
    ...
    public List getCustomersByName(String name)
    {
        ...
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto6.a.RentalService.getCustomersByName(String name)' --> " + ex, ex);
        }
    }
