...
public abstract class RentalServiceBase implements RentalService
{
    ...
    /**
     * TODO: Model Documentation for RentalService.getAllCars
     * @return List
    ...
    /**
     * TODO: Model Documentation for RentalService.getCustomersByName
     * @param name
     * @return List
     * @throws RentalException
     */
    public List getCustomersByName(String name) throws RentalException
    {
        if (name == null)
        {
            throw new IllegalArgumentException("org.andromda.test.howto16.a.RentalServiceBean.getCustomersByName(String name) - 'name' can not be null");
        }
        try
        {
