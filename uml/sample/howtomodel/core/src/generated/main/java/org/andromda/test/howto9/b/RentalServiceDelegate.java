...
/**
 * Web service delegator for {@link org.andromda.test.howto9.b.RentalServiceBean}.
 *
 * @see org.andromda.test.howto9.b.RentalServiceBean
 */
    ...
    extends ServiceDelegateBase
{
    ...
    {
        return ServiceLocator.getInstance().get_org_andromda_test_howto9_b_RentalServiceBean_Remote(getProperties());
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto9.b.RentalServiceBean#getAllCars()
     *
     * @return List
        ...
        throws RentalException
    {
        ...
        catch (NamingException ex)
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto9.b.RentalService.getAllCars()' --> " + ex, ex);
        }
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto9.b.RentalServiceBean#getCustomersByName(String)
     *
     * @param name
     * @return List
     * @throws RentalException
        ...
        throws RentalException
    {
        ...
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto9.b.RentalService.getCustomersByName(String name)' --> " + ex, ex);
        }
    }
