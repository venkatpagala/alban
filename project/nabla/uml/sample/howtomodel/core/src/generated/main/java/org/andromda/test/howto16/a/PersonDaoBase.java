    ...
    implements PersonDao
{
    ...
    protected Object transformEntity(final int transform, final Person entity)
    {
        ...
        if (entity != null)
        {
            switch (transform)
            {
                case PersonDao.TRANSFORM_PERSONVALUEOBJECT :
                    target = toPersonValueObject(entity);
                    break;
    ...
    protected void transformEntities(final int transform, final Collection entities)
    {
        ...
        {
            case PersonDao.TRANSFORM_PERSONVALUEOBJECT :
                toPersonValueObjectCollection(entities);
                break;
            case TRANSFORM_NONE : // fall-through
                default:
                // do nothing;
    ...
    protected PersonValueObject toPersonValueObject(Object[] row)
    {
        ...
        if (row != null)
        {
            ...
            for (int ctr = 0; ctr < numberOfObjects; ctr++)
            {
                ...
                {
                    target = this.toPersonValueObject((Person)object);
                    break;
                }
            }
        }
     ...
     * (which result in an array of objects) to {@link PersonValueObject}
    ...
    private Transformer PERSONVALUEOBJECT_TRANSFORMER =
        new Transformer()
        {
            public Object transform(Object input)
            {
                ...
                {
                    result = toPersonValueObject((Person)input);
                }
                else if (input instanceof Object[])
                {
                    result = toPersonValueObject((Object[])input);
                }
                return result;
            }
        };
    ...
    public PersonValueObject toPersonValueObject(final Person entity)
    {
        ...
        this.toPersonValueObject(entity, target);
        return target;
    }
        ...
        boolean copyIfNull)
    {
        ...
        if (copyIfNull || source.getBirthDate() != null)
        {
            target.setBirthDate(source.getBirthDate());
        }
    }
