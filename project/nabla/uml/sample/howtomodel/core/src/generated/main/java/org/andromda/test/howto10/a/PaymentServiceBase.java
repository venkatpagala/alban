    ...
    implements PaymentService
{
    ...
    public void register(Person owner, Car car, int leasePeriod)
    {
        if (owner == null)
        {
            throw new IllegalArgumentException(
                "org.andromda.test.howto10.a.PaymentServiceBean.register(Person owner, Car car, int leasePeriod) - 'owner' can not be null");
        }
        if (car == null)
        {
            throw new IllegalArgumentException(
                "org.andromda.test.howto10.a.PaymentServiceBean.register(Person owner, Car car, int leasePeriod) - 'car' can not be null");
        }
        try
        {
        ...
        catch (Throwable th)
        {
            throw new PaymentServiceException(
                "Error performing 'PaymentService.register(Person owner, Car car, int leasePeriod)' --> " + th,
                th);
        }
    }
     ...
     */
    protected abstract void handleRegister(Person owner, Car car, int leasePeriod)
        throws Exception;
