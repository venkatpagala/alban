...
call mvn -U -B clean install -Dserver=jetty9x -Dsurefire.useFile=false -Psample,jacoco,integration,run-its,arq-jbossas-managed -Darquillian=arq-jbossas-managed -Darquillian.launch=arq-jbossas-managed > install.log 2>&1
