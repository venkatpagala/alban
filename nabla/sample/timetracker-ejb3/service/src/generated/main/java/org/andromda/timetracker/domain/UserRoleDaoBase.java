    ...
    implements UserRoleDao
{
     ...
     */
    @Deprecated
    protected Log logger = LogFactory.getLog(UserRoleDaoBase.class);
    ...
    public Object get(final int transform, final Long id)
    {
        ...
        final Object entity = this.sessionFactory.getCurrentSession().get(UserRoleImpl.class, id);
    ...
    {
        final Criteria criteria = this.sessionFactory.getCurrentSession().createCriteria(UserRoleImpl.class);
    ...
    public PaginationResult search(final int transform, final int pageNumber, final int pageSize, final Search search)
    {
        ...
        final PropertySearch propertySearch = new PropertySearch(
            this.sessionFactory.getCurrentSession(), UserRoleImpl.class, search);
