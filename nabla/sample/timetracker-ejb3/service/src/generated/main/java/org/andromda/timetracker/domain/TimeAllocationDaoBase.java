    ...
    implements TimeAllocationDao
{
     ...
     */
    @Deprecated
    protected Log logger = LogFactory.getLog(TimeAllocationDaoBase.class);
    ...
    public Object get(final int transform, final Long id)
    {
        ...
        final Object entity = this.sessionFactory.getCurrentSession().get(TimeAllocationImpl.class, id);
    ...
    {
        final Criteria criteria = this.sessionFactory.getCurrentSession().createCriteria(TimeAllocationImpl.class);
    ...
    public Object create(final int transform, final TimeAllocation timeAllocation)
    {
        ...
        this.sessionFactory.getCurrentSession().save(timeAllocation);
    ...
    public void update(TimeAllocation timeAllocation)
    {
        ...
        this.sessionFactory.getCurrentSession().update(timeAllocation);
    }
    ...
    public void remove(TimeAllocation timeAllocation)
    {
        ...
        this.sessionFactory.getCurrentSession().delete(timeAllocation);
    }
    ...
    public PaginationResult search(final int transform, final int pageNumber, final int pageSize, final Search search)
    {
        ...
        final PropertySearch propertySearch = new PropertySearch(
            this.sessionFactory.getCurrentSession(), TimeAllocationImpl.class, search);
