    ...
    implements TaskDao
{
        ...
        throws TaskDaoException
    {
        ...
        try
        {
            final Object entity = (Task)this.emanager.find(Task.class, id);
     ...
     */
    @Override
    public Task load( final Long id)
        throws TaskDaoException
    {
        ...
        throws TaskDaoException
    {
        try
        {
            Query query = emanager.createNamedQuery("Task.findAll");
