...
public abstract class UserDaoBase implements UserDao
{
    ...
    public Object load(final int transform, final Long id) throws UserDaoException
    {
        ...
        try
        {
            final Object entity = this.emanager.find(User.class, id);
    ...
    @Override
    @SuppressWarnings({ "unchecked" })
    public Collection<User> loadAll(final int transform) throws UserDaoException
    {
        try
        {
            final Query query = this.emanager.createNamedQuery("User.findAll");
    ...
    @Override
    // @SuppressWarnings({ "unchecked" })
    public Collection<User> create(final int transform, final Collection<User> entities) throws UserDaoException
    {
        if (entities == null)
        {
        ...
        try
        {
            ...
            {
                results.add((User) this.create(transform, entity));
            }
        }
        catch (final Exception ex)
        {
