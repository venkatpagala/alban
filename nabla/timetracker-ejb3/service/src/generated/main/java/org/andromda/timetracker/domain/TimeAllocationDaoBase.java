    ...
    implements TimeAllocationDao
{
    ...
    public Object create(
        ...
        TimePeriod timePeriod)
    {
        TimeAllocation createEntity = new TimeAllocationImpl();
        createEntity.setTimePeriod(timePeriod);
        ...
        TimePeriod timePeriod)
    {
        ...
        createEntity.setTimecard(timecard);
        createEntity.setTimePeriod(timePeriod);
        return this.create(transform, createEntity);
    }
     ...
     */
    @Override
    public final Collection toTimeAllocationVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<TimeAllocationVO>();
        if (entities != null)
        {
    ...
    public void timeAllocationVOToEntity(
        ...
        boolean copyIfNull)
    {
        // Do nothing for org.andromda.metafacades.emf.uml22.EntityAttributeLogicImpl[TimeAllocation.id]
    }
