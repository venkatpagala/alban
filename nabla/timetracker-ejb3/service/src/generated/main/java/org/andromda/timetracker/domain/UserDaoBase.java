    ...
    implements UserDao
{
    ...
    public Object create(
        ...
        String comment)
    {
        User createEntity = new UserImpl();
        createEntity.setUsername(username);
        createEntity.setPassword(password);
        createEntity.setFirstName(firstName);
        createEntity.setLastName(lastName);
        createEntity.setEmail(email);
        createEntity.setIsActive(isActive);
        createEntity.setCreationDate(creationDate);
        createEntity.setComment(comment);
     ...
     */
    @Override
    public final Collection toUserVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<UserVO>();
        if (entities != null)
        {
        ...
        boolean copyIfNull)
    {
        ...
        // Do nothing for org.andromda.cartridges.spring.metafacades.SpringManageableEntityAttributeLogicImpl[User.id]
    }
     ...
     */
    @Override
    public final Collection toUserDetailsVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<UserDetailsVO>();
        if (entities != null)
        {
        ...
        boolean copyIfNull)
    {
        ...
        // Do nothing for org.andromda.cartridges.spring.metafacades.SpringManageableEntityAttributeLogicImpl[User.id]
        // No conversion for target.roles (can't convert source.getRoles():org.andromda.timetracker.vo.UserRoleVO[] to Collection<org.andromda.timetracker.domain.UserRole>)
    }
