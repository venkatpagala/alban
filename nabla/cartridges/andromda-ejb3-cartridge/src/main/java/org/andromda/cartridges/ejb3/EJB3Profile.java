    ...
    extends UMLProfile
{
     ...
     */
    public static final String TAGGEDVALUE_PERSISTENCE_COLUMN_EMPTYABLE =
        profile.get("COLUMN_EMPTYABLE");
        
    /**
     * 'andromda_persistence_column_emailable' The tagged value to represent a column that is emailable.
     */
    public static final String TAGGEDVALUE_PERSISTENCE_COLUMN_EMAILABLE =
        profile.get("COLUMN_EMAILABLE");        
