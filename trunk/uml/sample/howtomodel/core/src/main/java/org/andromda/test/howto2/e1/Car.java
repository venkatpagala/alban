...
// @javax.persistence.EntityListeners({org.andromda.test.howto2.e1.CarListener.class})
...
public class Car extends CarEmbeddable implements Serializable, Comparable<Car>
{
     ...
     */
    public Car(String serial, String name, String type, Set<Person> owners)
    {
        super(serial, name, type, owners);
    }
