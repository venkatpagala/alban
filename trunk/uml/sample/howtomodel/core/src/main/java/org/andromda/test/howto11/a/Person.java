...
@NamedQueries({ @NamedQuery(name = "Person.findAll", query = "SELECT p from Person as p"), @NamedQuery(name = "Person.findByName", query = "SELECT p from Person as p WHERE p.name = :name") })
