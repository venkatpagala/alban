    ...
    implements CarDao
{
     ...
     * @see CarDao#load(int,)
     */
    public Object load(final int transform, final String serial, final String name)
        throws CarDaoException
    {
        ...
        {
            throw new IllegalArgumentException(
                "Car.load - 'name' can not be null");
        }
        try
        {
            final Object entity = (Car)emanager.find(Car.class, new CarPK( serial, name));
     ...
     * @see CarDao#load()
     */
    public Car load( final String serial, final String name)
        throws CarDaoException
    {
        ...
        throws CarDaoException
    {
        ...
        {
            throw new IllegalArgumentException(
                "Car.remove - 'name' can not be null");
        }
        try
        {
