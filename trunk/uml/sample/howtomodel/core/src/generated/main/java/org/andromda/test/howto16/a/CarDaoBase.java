    ...
    implements CarDao
{
    ...
    protected CareValueObject toCarVo(Object[] row)
    {
        ...
        if (row != null)
        {
            ...
            for (int ctr = 0; ctr < numberOfObjects; ctr++)
            {
                ...
                {
                    target = this.toCarVo((Car)object);
                    break;
                }
            }
        }
     ...
     * (which result in an array of objects) to {@link CareValueObject}
    ...
    private Transformer CARVO_TRANSFORMER =
        new Transformer()
        {
            public Object transform(Object input)
            {
                ...
                {
                    result = toCarVo((Car)input);
                }
                else if (input instanceof Object[])
                {
                    result = toCarVo((Object[])input);
                }
                return result;
            }
        };
