...
public abstract class RentalServiceBase implements RentalService
{
    ...
    /**
     * The companyCode resource injection
     */
    @Resource(name = "companyCode")
    protected String companyCode;

    /**
     * The maxRentals resource injection
     */
    @Resource(name = "maxRentals")
    protected int maxRentals;
    ...
    public List getCustomersByName(String name) throws RentalException
    {
        if (name == null)
        {
            throw new IllegalArgumentException("org.andromda.test.howto11.a.RentalServiceBean.getCustomersByName(String name) - 'name' can not be null");
        }
        try
        {
