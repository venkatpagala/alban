 ...
 * 
 */
public abstract class UserEndPointServiceBase
    implements UserEndPointService
{
        ...
        throws UserException
    {
        if (name == null)
        {
            throw new IllegalArgumentException(
                "org.andromda.test.howto18.a.UserEndPointServiceBean.addUser(String name) - 'name' can not be null");
        }
        try
        {
        ...
        catch (Throwable th)
        {
            throw new UserEndPointServiceException(
                "Error performing 'UserEndPointService.addUser(String name)' --> " + th,
                th);
        }
    }
     ...
     */
    protected abstract void handleAddUser(String name)
        throws Exception;
        ...
        throws UserException
    {
        ...
        {
            throw new UserEndPointServiceException(
                "Error performing 'UserEndPointService.getUser(Long id)' --> " + th,
                th);
        }
    }
     ...
     */
    protected abstract User handleGetUser(Long id)
        throws Exception;
