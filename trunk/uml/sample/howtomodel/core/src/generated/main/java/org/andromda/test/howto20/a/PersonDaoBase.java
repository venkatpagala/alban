...
public abstract class PersonDaoBase implements PersonDao
{
     ...
     * @see PersonDao#create(PersonName, Date)
     */
    @Override
    public Person create(PersonName name, Date birthDate) throws PersonDaoException
    {
     ...
     * @see PersonDao#create(int, PersonName, Date)
     * composite=false identifiers=1
     */
    @Override
    public Object create(final int transform, PersonName name, Date birthDate) throws PersonDaoException
    {
