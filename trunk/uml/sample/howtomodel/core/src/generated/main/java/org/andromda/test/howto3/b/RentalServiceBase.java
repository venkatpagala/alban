...
public abstract class RentalServiceBase implements RentalService
{
    ...
    /**
     * Inject persistence context secondaryManager
     */
    @PersistenceContext(unitName = "secondaryManager")
    protected EntityManager secondaryEntityManager;
    ...
    public List getCustomersByName(String name)    {
        if (name == null)
        {
            throw new IllegalArgumentException("org.andromda.test.howto3.b.RentalServiceBean.getCustomersByName(String name) - 'name' can not be null");
        }
        try
        {
