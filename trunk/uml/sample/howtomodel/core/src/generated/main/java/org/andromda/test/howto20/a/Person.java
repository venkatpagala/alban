...
/**
 * TODO: Model Documentation for org.andromda.test.howto20.a.Person
 *
...
public class Person implements Serializable, Comparable<Person>{
    private static final long serialVersionUID = 5398590447967475059L;
    ...
    /**
     * TODO: Model Documentation for org.andromda.test.howto20.a.Person.name
     * Get the name property.
     * @return PersonName The value of name
     */
    @Embedded
    @AttributeOverrides
    ({
        @AttributeOverride(name="firstName", column=@Column(name="NAME_FIRST_NAME", unique=true, nullable=false, insertable=true, updatable=true)),
        @AttributeOverride(name="surname", column=@Column(name="NAME_SURNAME", unique=true, nullable=false, insertable=true, updatable=true))
    })
    ...
    /**
     * TODO: Model Documentation for org.andromda.test.howto20.a.Person.birthDate
    ...
    /**
     * TODO: Model Documentation for org.andromda.test.howto20.a.Person.serial
