...
/**
 * Web service delegator for {@link org.andromda.test.howto4.b.RentalServiceBean}.
 *
 * @see org.andromda.test.howto4.b.RentalServiceBean
 */
    ...
    extends ServiceDelegateBase
{
    ...
    {
        return ServiceLocator.getInstance().get_org_andromda_test_howto4_b_RentalServiceBean_Remote(getProperties());
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto4.b.RentalServiceBean#getAllCars()
     *
     * @return List
     */
    public List getAllCars()
    {
        ...
        catch (NamingException ex)
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto4.b.RentalService.getAllCars()' --> " + ex, ex);
        }
    }

    /**
     * Call the session bean operation using appropriate view type
     * @see org.andromda.test.howto4.b.RentalServiceBean#getCustomersByName(String)
     *
     * @param name
     * @return List
     */
    public List getCustomersByName(String name)
    {
        ...
        {
            throw new RentalServiceException(
                "Error performing 'org.andromda.test.howto4.b.RentalService.getCustomersByName(String name)' --> " + ex, ex);
        }
    }
