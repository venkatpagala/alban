...
public abstract class CarDaoBase implements CarDao
{
     ...
     * @see CarDao#create(String, String, float)
     */
    @Override
    public Car create(String name, String type, float gearRatio) throws CarDaoException
    {
        return (Car)this.create(TRANSFORM_NONE, name, type, gearRatio);
    }

    /**
     * Create Entity Car using instance attributes with VO transformation
     * @see CarDao#create(int, String, String, float)
     * composite=false identifiers=1
     */
    @Override
    public Object create(final int transform, String name, String type, float gearRatio) throws CarDaoException
    {
        Car entity = new Car();
        entity.setName(name);
        entity.setType(type);
        entity.setGearRatio(gearRatio);
