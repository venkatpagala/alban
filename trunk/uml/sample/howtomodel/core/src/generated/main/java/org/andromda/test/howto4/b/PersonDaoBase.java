    ...
    implements PersonDao
{
     ...
     */
    public Object load(final int transform, final long id, final String tag)
        throws PersonDaoException
    {
        if (tag == null)
        {
            throw new IllegalArgumentException(
                "Person.load - 'tag' can not be null");
        }
        try
        {
            final Object entity = (Person)emanager.find(Person.class, new PersonPK( new Long(id), tag));
     ...
     * @see PersonDao#load()
     */
    public Person load( final long id, final String tag)
        throws PersonDaoException
    {
     ...
     */
    public void remove(long id, String tag)
        throws PersonDaoException
    {
        if (tag == null)
        {
            throw new IllegalArgumentException(
                "Person.remove - 'tag' can not be null");
        }
        try
        {
