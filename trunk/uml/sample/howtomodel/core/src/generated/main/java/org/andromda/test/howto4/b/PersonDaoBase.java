...
public abstract class PersonDaoBase implements PersonDao
{
     ...
     */
    @Override
    public Object load(final int transform, final long id, final String tag) throws PersonDaoException
    {
        if (tag == null)
        {
            throw new IllegalArgumentException("Person.load - 'tag' can not be null");
        }
        try
        {
                        final Person entity = this.entityManager.find(Person.class, new PersonPK( new Long(id), tag));
    ...
    /**
     * @see PersonDao#load( long, String)
     */
    @Override
        public Person load( final long id, final String tag) throws PersonDaoException
    {
        return (Person)this.load(TRANSFORM_NONE, id, tag);
    }
    ...
    /**
     * @see PersonDao#remove(long, String)
     */
    @Override
    public void remove(long id, String tag) throws PersonDaoException
    {
        if (tag == null)
        {
            throw new IllegalArgumentException("Person.remove - 'tag' can not be null");
        }
        try
        {
            final Person entity = this.load(id, tag);
            if (entity != null)
            {
                this.remove(entity);
            }
