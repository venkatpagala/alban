    ...
    implements Serializable, Comparable<Person>
{
    ...
    @JoinTable
    (
        name = "OWNERS2COMPANY_CARS",
        joinColumns = {@JoinColumn(name = "OWNERS_SERIAL_FK", referencedColumnName = "SERIAL")},
        inverseJoinColumns = {@JoinColumn(name = "COMPANY_CARS_SERIAL_FK", referencedColumnName = "SERIAL")}
    )
     ...
     * @param companyCars
     */
    public void setCompanyCars (Set<Car> companyCars)
    {
