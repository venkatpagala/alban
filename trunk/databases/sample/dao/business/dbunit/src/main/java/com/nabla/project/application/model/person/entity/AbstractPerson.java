    ...
    implements java.io.Serializable
{
    ...
    /** minimal constructor */
    public AbstractPerson( Long id, Address address, Date birthdate, String firstname, String lastname,
                           Boolean married, Integer nbchildren )
    {
        this.id = id;
    ...
    /** full constructor */
    public AbstractPerson( Long id, Address address, Date birthdate, String firstname, String lastname,
                           Boolean married, Integer nbchildren, Set<Activity> activities )
    {
        this.id = id;
        this.address = address;
        this.birthdate = birthdate;
    ...
    */
    ...
    @ManyToMany(  )
    @JoinTable( 
            name = "PERSONACTIVITY", joinColumns = @JoinColumn( name = "PERSON_ID" )
    , inverseJoinColumns = @JoinColumn( name = "ACTIVITY_ID" )

         )
    /*
    @ManyToMany(cascade = { CascadeType.ALL }, fetch = FetchType.LAZY)
    @JoinTable(name = "PERSONACTIVITY", schema = "APP", joinColumns = { @JoinColumn(name = "PERSON_ID", unique = false, nullable = true, insertable = true, updatable = false) }, inverseJoinColumns = { @JoinColumn(name = "ACTIVITY_ID", unique = false, nullable = true, insertable = true, updatable = false) })
    */
