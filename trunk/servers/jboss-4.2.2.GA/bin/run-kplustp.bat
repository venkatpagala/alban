...
rem set JAVA_HOME=C:\Program Files (x86)\Java\jdk1.5.0_22
...
set PATH=C:\eclipse-3.5\plugins\org.eclipse.tptp.platform.ac.win_ia32_4.4.202.v201002100300\agent_controller\bin;%PATH%

rem set PROFILER_AGENT=-XrunpiAgent:server=enabled

:RESTART
"%JAVA%" %JAVA_OPTS% "-Djava.endorsed.dirs=%JBOSS_ENDORSED_DIRS%" %PROFILER_AGENT% -classpath "%JBOSS_CLASSPATH%" org.jboss.Main -c kplustp %*
