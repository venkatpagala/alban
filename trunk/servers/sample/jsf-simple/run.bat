...
REM mvn clean install cargo:undeploy cargo:deploy -Psample -Dserver=tomcat7x -Ddatabase=derby
...
call mvn org.codehaus.cargo:cargo-maven2-plugin:run -Psample,arq-jbossas-managed -Dserver=jboss7x > deploy.log 2>&1
