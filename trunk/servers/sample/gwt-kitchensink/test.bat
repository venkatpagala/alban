...
call mvn test -Parq-jbossas-managed,with.test -Dserver=jboss7x -Ddatabase=h2 > test.log 2>&1
...
REM NOK in jboss7x call mvn test -Parq-jbossas-managed,with.test -Dserver=jboss7x -Ddatabase=derby > test.log 2>&1
