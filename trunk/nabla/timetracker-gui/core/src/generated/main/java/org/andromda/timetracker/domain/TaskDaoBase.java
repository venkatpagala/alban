    ...
    implements TaskDao
{
    ...
    public Object create(
        ...
        String name)
    {
        Task createEntity = new TaskImpl();
     ...
     */
    @Override
    public final Collection toTaskVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<TaskVO>();
        if (entities != null)
        {
        ...
        boolean copyIfNull)
    {
        ...
        // Do nothing for org.andromda.cartridges.spring.metafacades.SpringManageableEntityAttributeLogicImpl[Task.id]
    }
