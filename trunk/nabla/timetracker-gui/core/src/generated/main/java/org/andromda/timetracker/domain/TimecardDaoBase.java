    ...
    implements TimecardDao
{
        ...
        User submitter)
    {
        ...
        createEntity.setStartDate(startDate);
        createEntity.setStatus(status);
        createEntity.setSubmitter(submitter);
        return this.create(transform, createEntity);
    }
     ...
     */
    @Override
    public final Collection toTimecardSummaryVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<TimecardSummaryVO>();
        if (entities != null)
        {
     ...
     */
    @Override
    public final Collection toTimecardVOCollection(Collection<?> entities)
    {
        Collection result = new ArrayList<TimecardVO>();
        if (entities != null)
        {
