...
SearchTimecardsSearchFormImpl)
     ...
     * @return forward
     */
    protected String _populateSearchScreen(final SearchTimecardsSearchFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _populateSearchScreen(final SearchTimecardsSearchFormImpl form)
        throws Throwable
    {
        String forward = null;
        populateSearchScreen(form);
        forward = "search-timecards-search-timecards";
        forward = _populateSearchScreen(form, forward);
        return forward;
    }
...
SearchTimecardsDetailsFormImpl)
     ...
     * @return forward
     */
    protected String _initializeTimecardId(final SearchTimecardsDetailsFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _initializeTimecardId(final SearchTimecardsDetailsFormImpl form)
        throws Throwable
    {
        String forward = null;
        initializeTimecardId(form);
        forward = ((TimecardController)this.resolveVariable("timecardController")).timecardDetails();
        forward = _initializeTimecardId(form, forward);
        return forward;
    }
...
SearchTimecardsFormImpl)
     ...
     * @return forward
     */
    protected String _populateSearchScreen(final SearchTimecardsFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _populateSearchScreen(final SearchTimecardsFormImpl form)
        throws Throwable
    {
        String forward = null;
        populateSearchScreen(form);
