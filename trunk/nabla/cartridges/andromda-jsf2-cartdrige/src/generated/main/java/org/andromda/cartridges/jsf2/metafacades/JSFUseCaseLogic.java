    ...
    implements JSFUseCase
{
    ...
    */
    ...
    /**
     * <p><b>Constraint:</b> org::andromda::cartridges::jsf2::metafacades::JSFUseCase::one registration use case</p>
     * <p><b>Error:</b> Only one use case in your model can be identified as a registration use case.</p>
     * <p><b>OCL:</b> context JSFUseCase inv: registrationUseCases->notEmpty() implies registrationUseCases -> size() = 1</p>
    ...
    public void validateInvariants(Collection<ModelValidationMessage> validationMessages)
    {
        ...
        try
        {
            ...
            boolean constraintValid = OCLResultEnsurer.ensure((Boolean.valueOf(String.valueOf(OCLCollections.notEmpty(OCLIntrospector.invoke(contextElement,"registrationUseCases")))).booleanValue()?OCLExpressions.equal(OCLCollections.size(OCLIntrospector.invoke(contextElement,"registrationUseCases")),1):true));
            if (!constraintValid)
            {
                validationMessages.add(
                    new ModelValidationMessage(
                        (MetafacadeBase)contextElement ,
                        "org::andromda::cartridges::jsf2::metafacades::JSFUseCase::one registration use case",
                        "Only one use case in your model can be identified as a registration use case."));
            }
        }
        catch (Throwable th)
        {
            ...
            logger.error("Error validating constraint 'org::andromda::cartridges::jsf2::metafacades::JSFUseCase::one registration use case' ON "
