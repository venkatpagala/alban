...
// Generated by DaoBase.vsl in andromda-ejb3-cartridge on 01/06/2012 04:08:31.
//
    ...
    implements TimecardDao
{
        ...
        throws TimecardDaoException
    {
        ...
        try
        {
            final Object entity = (Timecard)this.emanager.find(Timecard.class, id);
     ...
     */
    @Override
    public Timecard load( final Long id)
        throws TimecardDaoException
    {
        ...
        throws TimecardDaoException
    {
        try
        {
            Query query = emanager.createNamedQuery("Timecard.findAll");
    ...
    /**
     * @see TimecardDao#create(TimecardStatus, Date, String)
     */
    @Override
    public Timecard create(
        ...
        throws TimecardDaoException
    {
        return (Timecard)this.create(TRANSFORM_NONE, status, startDate, comments);
    }

    /**
     * @see TimecardDao#create(int, TimecardStatus, Date, String)
     */
    @Override
