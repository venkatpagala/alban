...
// Generated by ServiceLocator.vsl in andromda-ejb3-cartridge on 03/30/2012 03:34:20.
//
...
public class ServiceLocator
{
     ...
     */
    public final UserServiceRemote get_org_andromda_timetracker_service_UserServiceBean_Remote(Properties env)
        throws NamingException
    {
        return (UserServiceRemote)
            getContext(env).lookup("timetracker-ejb3-3.4/UserServiceBean/remote");
    }
     ...
     * @throws NamingException failure to lookup remote service interface.
     */
    public final TimeTrackingServiceRemote get_org_andromda_timetracker_service_TimeTrackingServiceBean_Remote(Properties env)
        throws NamingException
    {
        return (TimeTrackingServiceRemote)
            getContext(env).lookup("timetracker-ejb3-3.4/TimeTrackingServiceBean/remote");
    }
     ...
     * @throws NamingException failure to lookup remote service interface.
     */
    public final SecurityServiceRemote get_org_andromda_timetracker_service_SecurityServiceBean_Remote(Properties env)
        throws NamingException
    {
        return (SecurityServiceRemote)
            getContext(env).lookup("timetracker-ejb3-3.4/SecurityServiceBean/remote");
    }
