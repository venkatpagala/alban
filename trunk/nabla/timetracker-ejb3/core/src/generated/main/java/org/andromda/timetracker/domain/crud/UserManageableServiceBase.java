...
// Generated by crud/ManageableServiceBase.vsl in andromda-ejb3-cartridge on 03/30/2012 03:34:21.
//
    ...
    implements UserManageableService
{
    ...
    {
        try{
            return (User)emanager.find(User.class, id);
        }
        catch (Exception ex)
        {
            throw new UserReadManageableException(ex);
        ...
        throws UserReadManageableException
    {
        ...
        if (isActive)
        {
            buf.append("entity.isActive is true");
        }
        else
        {
            buf.append("entity.isActive is not true");
        }
        logicalOperator = " and ";
        if (creationDate != null)
        {
        ...
        try
        {
            ...
            query.setParameter("isActive", new Boolean(isActive));
            if (roles != null && roles.length > 0)
            {
