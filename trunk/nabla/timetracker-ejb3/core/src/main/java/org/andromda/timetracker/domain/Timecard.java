...
public class Timecard extends org.andromda.timetracker.domain.TimecardEmbeddable implements java.io.Serializable, Comparable<Timecard>
{
    /**
     ...
     *
     */
    public Timecard(final org.andromda.timetracker.domain.TimecardStatus status, final java.util.Date startDate, final java.lang.String comments)
    {
    ...
    {
        super(status, startDate, comments, submitter, approver, allocations);
    }
    ...
    public static java.util.List findByCriteria(final org.andromda.timetracker.vo.TimecardSearchCriteriaVO criteria)
    {
