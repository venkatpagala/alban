    ...
    implements TimecardDao
{
     ...
     */
    @Deprecated
    protected Log logger = LogFactory.getLog(TimecardDaoBase.class);
    ...
    public Object get(final int transform, final Long id)
    {
        ...
        final Object entity = this.sessionFactory.getCurrentSession().get(TimecardImpl.class, id);
    ...
    {
        final Criteria criteria = this.sessionFactory.getCurrentSession().createCriteria(TimecardImpl.class);
    ...
    public Object create(final int transform, final Timecard timecard)
    {
        ...
        this.sessionFactory.getCurrentSession().save(timecard);
    ...
    public void update(Timecard timecard)
    {
        ...
        this.sessionFactory.getCurrentSession().update(timecard);
    }
    ...
    public void remove(Timecard timecard)
    {
        ...
        this.sessionFactory.getCurrentSession().delete(timecard);
    }
    ...
    public PaginationResult search(final int transform, final int pageNumber, final int pageSize, final Search search)
    {
        ...
        final PropertySearch propertySearch = new PropertySearch(
            this.sessionFactory.getCurrentSession(), TimecardImpl.class, search);
