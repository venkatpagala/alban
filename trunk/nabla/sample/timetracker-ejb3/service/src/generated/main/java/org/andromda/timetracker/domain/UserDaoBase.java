    ...
    implements UserDao
{
     ...
     */
    @Deprecated
    protected Log logger = LogFactory.getLog(UserDaoBase.class);
    ...
    public Object get(final int transform, final Long id)
    {
        ...
        final Object entity = this.sessionFactory.getCurrentSession().get(UserImpl.class, id);
    ...
    {
        final Criteria criteria = this.sessionFactory.getCurrentSession().createCriteria(UserImpl.class);
    ...
    public PaginationResult search(final int transform, final int pageNumber, final int pageSize, final Search search)
    {
        ...
        final PropertySearch propertySearch = new PropertySearch(
            this.sessionFactory.getCurrentSession(), UserImpl.class, search);
