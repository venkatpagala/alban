    ...
    implements TaskDao
{
     ...
     */
    @Deprecated
    protected Log logger = LogFactory.getLog(TaskDaoBase.class);
    ...
    public Object get(final int transform, final Long id)
    {
        ...
        final Object entity = this.sessionFactory.getCurrentSession().get(TaskImpl.class, id);
    ...
    {
        final Criteria criteria = this.sessionFactory.getCurrentSession().createCriteria(TaskImpl.class);
    ...
    public PaginationResult search(final int transform, final int pageNumber, final int pageSize, final Search search)
    {
        ...
        final PropertySearch propertySearch = new PropertySearch(
            this.sessionFactory.getCurrentSession(), TaskImpl.class, search);
