...
call setenv.bat 
REM OK call mvn clean install -Psample -Dserver=jboss5x -Ddatabase=h2 > install.log 2>&1
...
call mvn clean install -Psample,arq-jbossas-managed,!microcontainer-openejb -Dserver=jboss5x -Ddatabase=h2 > install.log 2>&1
