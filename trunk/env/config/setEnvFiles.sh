...
if [ "${TARGET_FILE}" != "" ]; then
    ...
    perl ${REPLACE_EXE} -v -f ${TARGET_FILE} -o ${REPLACE_REMOVE_OPT} -p ${THIRDPARTY_PROPERTIES},${USER_COMMON_PROPERTIES},${USER_PROP_FILE},${USER_PROP_FILE_WIN}

else
  if [ "${ONE_FILE}" != "" ]; then
    perl ${REPLACE_EXE} -v -o ${REPLACE_REMOVE_OPT} -p ${THIRDPARTY_PROPERTIES},${USER_COMMON_PROPERTIES},${USER_PROP_FILE},${USER_PROP_FILE_WIN} ${PATH_P}/${ONE_FILE}
  else
