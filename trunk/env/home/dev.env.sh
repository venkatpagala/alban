...
export PROJECT_TARGET=${DRIVE_PATH}/${PROJECT_BUILD_TYPE}
...
export PROJECT_RELEASE=${PROJECT_TARGET}/release/${PROJECT_MAJOR_VERSION}
export PROJECT_PKG=${PROJECT_TARGET}/pkg/${PROJECT_MAJOR_VERSION}
...
#################################################################################
LIB_LINK_DIR="${PROJECT_TARGET}/lib/${ARCH}"
echo $LIB_LINK_DIR
...
case ${MACHINE} in
    ...
    ;;
    rs6000)
      export LD_LIBRARY_PATH=${PROJECT_TARGET}/lib/${ARCH}/opt/shared:${PROJECT_TARGET}/lib/${ARCH}/opt
    ;;
    *)
      export LD_LIBRARY_PATH=""
    ;;
