...
/* Autogenerated by AndroMDA (ManageableServiceLocator.vsl) - do not edit */
...
public class ManageableServiceLocator
{
     ...
     */
    public final PersonManageableService getPersonManageableService()
        throws NamingException
    {
     ...
     * @throws NamingException failure to lookup remote manageable service interface.
     */
    public final PersonManageableService getPersonManageableServiceRemote(Properties env)
        throws NamingException
    {
        return (PersonManageableService)
            getContext(env).lookup("howtomodel-1.0-SNAPSHOT/PersonManageableService/remote");
    }
     ...
     * @throws NamingException failure to lookup remote manageable service interface.
     */
    public final PersonManageableService getPersonManageableServiceLocal(Properties env)
        throws NamingException
    {
        return (PersonManageableService)
            getContext(env).lookup("howtomodel-1.0-SNAPSHOT/PersonManageableService/local");
    }
    /**
     ...
     * @throws NamingException failure to lookup remote manageable service interface.
     */
    public final CarManageableService getCarManageableService()
        throws NamingException
    {
     ...
     * @throws NamingException failure to lookup remote manageable service interface.
     */
    public final CarManageableService getCarManageableServiceRemote(Properties env)
        throws NamingException
    {
        return (CarManageableService)
            getContext(env).lookup("howtomodel-1.0-SNAPSHOT/CarManageableService/remote");
    }
     ...
     * @throws NamingException failure to lookup remote manageable service interface.
     */
    public final CarManageableService getCarManageableServiceLocal(Properties env)
        throws NamingException
    {
        return (CarManageableService)
            getContext(env).lookup("howtomodel-1.0-SNAPSHOT/CarManageableService/local");
    }
