    ...
    implements UserService
{
        ...
        throws UserException
    {
        if (user == null)
        {
            throw new IllegalArgumentException(
                "org.andromda.test.howto18.a.UserServiceBean.addUser(User user) - 'user' can not be null");
        }
        try
        {
        ...
        catch (Throwable th)
        {
            throw new UserServiceException(
                "Error performing 'UserService.addUser(User user)' --> " + th,
                th);
        }
    }
        ...
        throws UserException
    {
        ...
        {
            throw new UserServiceException(
                "Error performing 'UserService.getUser(Long id)' --> " + th,
                th);
        }
    }
     ...
     */
    protected abstract Collection handleGetAllUsers()
        throws Exception;
